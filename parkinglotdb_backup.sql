...
INSERT INTO `parking_spots` VALUES (1,'A1',1),(2,'A2',1),(3,'B1',1),(4,'B2',1);
...
CREATE TABLE `reservations` (
  ...
  CONSTRAINT `reservations_ibfk_2` FOREIGN KEY (`spot_id`) REFERENCES `parking_spots` (`spot_id`) ON DELETE CASCADE
...
INSERT INTO `reservations` VALUES (3,1,4),(6,1,1),(7,1,1),(8,1,4);
...
INSERT INTO `users` VALUES (1,'admin','adminpass','manager'),(2,'driver1','driverpass','driver');
...
-- Dump completed on 2025-03-16 13:22:03
